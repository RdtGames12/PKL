      ...
      <tbody class="bg-white divide-y divide-gray-200">
        <tr v-for="book in books" :key="book.id">
          ...
          <td class="w-px border-t">
            <Link :href="`/books/${book.id}/edit`" :preserve-scroll :preserve-state class="btn-indigo  flex items-center px-auto" tabindex="-1">
              <icon name="cheveron-right" class="block w-6 h-6 fill-gray-400" />Lihat Detail
            </Link>
          </td>
        </tr>
      </tbody>
